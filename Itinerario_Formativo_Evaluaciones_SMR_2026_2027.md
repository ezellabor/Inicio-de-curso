...
gantt
    ...
    section Trimestres
    1.er Trimestre                :a1, 2026-09-01, 2026-12-22
    2.º Trimestre                 :a2, 2027-01-08, 2027-03-12
    3.er Trimestre / Dual / FCT  :a3, 2027-03-15, 2027-06-20

    section Evaluaciones
    Inicio de Curso               :milestone, m1, 2026-09-01, 0d
    Evaluación Inicial            :milestone, m2, 2026-10-23, 0d
    1.ª Evaluación Parcial        :milestone, m3, 2026-12-18, 0d
    2.ª Evaluación Parcial        :milestone, m4, 2027-03-05, 0d
    Evaluación Final Ordinaria    :milestone, m5, 2027-05-28, 0d
    Evaluación Extraordinaria     :milestone, m6, 2027-06-18, 0d

    section Fases de Aprendizaje
    Acogida y Diagnóstico (Fase 1):p1, 2026-09-01, 2026-10-31
    Formación en Aula (Fase 2 y 3) :p2, 2026-11-01, 2027-03-12
    Fase Dual / FCT en Empresa    :p3, 2027-03-15, 2027-05-25
```
...
flowchart TD
    ...
    subgraph F2["FASE 2: 1.er Trimestre y Formación Troncal (Nov - Dic 2026)"]
        D --> E["Impartición de Módulos (Montaje, Redes, Sistemas, etc.)"]
        E --> F["Atención tutorial y control semanal de asistencia"]
        F --> G["<b>1.ª EVALUACIÓN PARCIAL</b><br/><i>(Boletín de calificaciones)</i>"]
    end
    ...
    subgraph F4["FASE 4: Formación en Empresa y Cierre (Mar - Jun 2027)"]
        ...
        N -- No --> P["Superación de Curso / Titulación"]
        O --> P
    end
...
| **Pérdida de Evaluación Continua** | 15% (GM) y 20% (GS) de faltas lectivas (justif/injustif) del módulo | Mantiene la matrícula y asistencia. Pierde pruebas parciales y realiza examen final/global. | Aplicación según Criterios de la Programación Didáctica. <!-- / RRI-->|
